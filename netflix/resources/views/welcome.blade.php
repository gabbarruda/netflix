    ...
    <body>
        <main class="main">
            <div class="main-child">
                <h1 class="our-story-card-title" data-uia="hero-title">Filmes, séries e muito mais. Sem limites.</h1>
        ...
        <footer class="footer">
            ...
            <p>Copyright <i class="fa-sharp fa-solid fa-copyright"></i> 2022 Netflix Brasil</p>
        </footer>
    </body>
